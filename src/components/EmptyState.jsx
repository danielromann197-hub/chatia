  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-6 text-center w-full animate-fade-in-up mt-[10vh]">
      <div className="flex flex-col items-center mb-8">
        ...
        <div className="w-16 h-16 rounded-full bg-[#1A1A1A] flex items-center justify-center border border-[#333333] shadow-md mb-6">
           <span className="font-anton text-2xl text-white">C7<span className="text-[#FFD000]">.</span></span>
        </div>
