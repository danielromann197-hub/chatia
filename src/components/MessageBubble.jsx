              ...
              <ReactMarkdown 
                 components={{
                   ...
                   code({node, className, children, ...props}) {
                     ...
                     // In react-markdown v9+, inline is removed. We use the match to see if it has a language.
                     // But we should also check if it contains newline to be a block vs inline.
